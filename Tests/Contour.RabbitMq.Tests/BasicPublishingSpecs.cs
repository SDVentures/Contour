...
namespace Contour.RabbitMq.Tests
{
    ...
    public class BasicPublishingSpecs
    {
        ...
        /// <summary>
        /// ѕри регистрации отправител€ с возможностью послать сообщение с любой меткой.
        /// </summary>
        [TestFixture]
        [Category("Integration")]
        ...
        {
            /// <summary>
            /// Ќе должно генерироватьс€ исключение при отправке сообщени€.
            /// </summary>
            [Test]
            ...
            /// <summary>
            /// —ообщение должно быть доставлено до адресата.
            /// </summary>
            [Test]
            ...
            /// <summary>
            /// —ообщение при динамическом и статическом роутинге должно быть доставлено до адресата.
            /// </summary>
            [Test]
            ...
            /// <summary>
            /// ћожет быть получен ответ на такой запрос.
            /// </summary>
            [Test]
            ...
            /// <summary>
            /// ћожет быть получен ответ на любые типы запросов..
            /// </summary>
            [Test]
