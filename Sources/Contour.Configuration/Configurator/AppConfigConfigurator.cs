...
namespace Contour.Configuration.Configurator
{
    ...
    public class AppConfigConfigurator : IConfigurator
    {
        ...
        public IEnumerable<string> Endpoints
        {
            get
            {
                return Enumerable.OfType<EndpointElement>(this.endpointsConfig.Endpoints)
                    .Select(e => e.Name);
            }
        }
        ...
        public string GetEvent(string endpointName, string key)
        {
            ...
            IEnumerable<MessageElement> messages = Enumerable.Cast<MessageElement>(endpoint.Outgoing).
                Concat(Enumerable.Cast<MessageElement>(endpoint.Incoming));
        ...
        public IRequestConfiguration GetRequestConfig(string endpointName, string key)
        {
            ...
            OutgoingElement reqDeclaration = Enumerable.Cast<OutgoingElement>(endpoint.Outgoing).
                First(x => x.Key == key);
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Contour.IBusLifecycleHandler"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Contour.Validation.IMessageValidator"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Contour.Validation.MessageValidatorGroup"/>.
        /// </returns>
        ...
        /// <returns><see cref="Contour.Transport.RabbitMq.Internal.IProducerSelector"/></returns>
