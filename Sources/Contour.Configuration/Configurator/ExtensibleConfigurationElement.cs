namespace Contour.Configuration.Configurator
{
    ...
    /// <summary>
    /// Extensible with undefined in code configuration elements and attributes configuration element 
    /// </summary>
    public class ExtensibleConfigurationElement : ConfigurationElement
    {
        /// <summary>
